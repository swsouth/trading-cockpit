 ...
 *
 * 200 stocks per weekday = 1,000 total unique stocks covered each week
 * Each day focuses on specific sectors to provide thematic diversification
 *
 * Monday: Technology & Software
 * Tuesday: Finance & Energy
 * Wednesday: Healthcare & Consumer
 * Thursday: Industrials & Materials
 * Friday: Cyclical & Small-cap Growth
 *
 * Recommendations accumulate throughout the week (Mon+Tue+Wed+Thu+Fri visible)
 * Expire after 7 days via expires_at timestamp
 */

import { StockUniverseEntry } from './stockUniverse';

/**
 * MONDAY UNIVERSE - 200 stocks
 * Theme: Technology & Software (Mega-cap tech, semiconductors, cloud, cybersecurity, AI)
 */
export const MONDAY_UNIVERSE: StockUniverseEntry[] = [
  // Mega-cap Tech (20)
  ...
  // Communication Services - Tech Focus (30)
  ...
  // Data Centers & Infrastructure (10)
...
/**
 * TUESDAY UNIVERSE - 200 stocks
 * Theme: Finance & Energy (Banks, insurance, oil & gas, renewables)
 */
export const TUESDAY_UNIVERSE: StockUniverseEntry[] = [
  // Banking & Capital Markets (50)
...
/**
 * WEDNESDAY UNIVERSE - 200 stocks
 * Theme: Healthcare & Consumer (Pharma, biotech, retail, staples)
 */
export const WEDNESDAY_UNIVERSE: StockUniverseEntry[] = [
  // Healthcare - Pharma & Biotech (60)
  ...
  // Consumer Cyclical - Retail & E-commerce (100)
...
/**
 * THURSDAY UNIVERSE - 200 stocks
 * Theme: Industrials & Materials (Aerospace, transportation, chemicals, construction)
 */
export const THURSDAY_UNIVERSE: StockUniverseEntry[] = [
  ...
  { symbol: 'MAS', company_name: 'Masco Corporation', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'OC', company_name: 'Owens Corning', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'SSD', company_name: 'Simpson Manufacturing Co.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'MIDD', company_name: 'Middleby Corporation', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'TT', company_name: 'Trane Technologies plc', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'WTS', company_name: 'Watts Water Technologies', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'AIT', company_name: 'Applied Industrial Technologies', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'DCI', company_name: 'Donaldson Company Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'NDSN', company_name: 'Nordson Corporation', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'RRX', company_name: 'Regal Rexnord Corporation', sector: 'Industrials', data_source: 'sp500' },

  { symbol: 'AYI', company_name: 'Acuity Brands Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'BWA', company_name: 'BorgWarner Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'HUBB', company_name: 'Hubbell Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'JKHY', company_name: 'Jack Henry & Associates Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'J', company_name: 'Jacobs Solutions Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'PWR', company_name: 'Quanta Services Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'URI', company_name: 'United Rentals Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'WSO', company_name: 'Watsco Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'GWW', company_name: 'W.W. Grainger Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'TRMB', company_name: 'Trimble Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'PLAB', company_name: 'Photronics Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'ACA', company_name: 'Arcosa Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'KAMN', company_name: 'Kaman Corporation', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'MOG.A', company_name: 'Moog Inc. Class A', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'CW', company_name: 'Curtiss-Wright Corporation', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'TTC', company_name: 'Toro Co.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'AL', company_name: 'Air Lease Corporation', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'R', company_name: 'Ryder System Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'KEX', company_name: 'Kirby Corporation', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'MATX', company_name: 'Matson Inc.', sector: 'Industrials', data_source: 'sp500' },

  // Building Materials & Construction (40)
  { symbol: 'BLD', company_name: 'TopBuild Corp.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'AZEK', company_name: 'AZEK Company Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'FBIN', company_name: 'Fortune Brands Innovations', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'UFPI', company_name: 'UFP Industries Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'LPX', company_name: 'Louisiana-Pacific Corporation', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'FND', company_name: 'Floor & Decor Holdings Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'BECN', company_name: 'Beacon Roofing Supply Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'DOOR', company_name: 'Masonite International Corp.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'CSL', company_name: 'Carlisle Companies Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'MLI', company_name: 'Mueller Industries Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'KBH', company_name: 'KB Home', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'PHM', company_name: 'PulteGroup Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'TOL', company_name: 'Toll Brothers Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'MTH', company_name: 'Meritage Homes Corporation', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'TMHC', company_name: 'Taylor Morrison Home Corp.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'MHO', company_name: 'M/I Homes Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'CCS', company_name: 'Century Communities Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'CVCO', company_name: 'Cavco Industries Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'SKY', company_name: 'Skyline Champion Corporation', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'LGIH', company_name: 'LGI Homes Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'BZH', company_name: 'Beazer Homes USA Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'GRBK', company_name: 'Green Brick Partners Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'DFH', company_name: 'Dream Finders Homes Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'HOUS', company_name: 'Anywhere Real Estate Inc.', sector: 'Real Estate', data_source: 'nasdaq' },
  { symbol: 'RDFN', company_name: 'Redfin Corporation', sector: 'Real Estate', data_source: 'nasdaq' },
  { symbol: 'COMP', company_name: 'Compass Inc.', sector: 'Real Estate', data_source: 'nasdaq' },
  { symbol: 'OPEN', company_name: 'Opendoor Technologies Inc.', sector: 'Real Estate', data_source: 'nasdaq' },
  { symbol: 'EXPI', company_name: 'eXp World Holdings Inc.', sector: 'Real Estate', data_source: 'nasdaq' },
  { symbol: 'RMAX', company_name: 'RE/MAX Holdings Inc.', sector: 'Real Estate', data_source: 'nasdaq' },
  { symbol: 'Z', company_name: 'Zillow Group Inc.', sector: 'Real Estate', data_source: 'nasdaq' },
  { symbol: 'RDFN', company_name: 'Redfin Corporation', sector: 'Real Estate', data_source: 'nasdaq' },
  { symbol: 'PCOR', company_name: 'Procore Technologies Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'RH', company_name: 'RH (Restoration Hardware)', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'WSM', company_name: 'Williams-Sonoma Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'LL', company_name: 'LL Flooring Holdings Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'TILE', company_name: 'Interface Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'AWI', company_name: 'Armstrong World Industries', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'UFPI', company_name: 'UFP Industries Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'TREX', company_name: 'Trex Company Inc.', sector: 'Industrials', data_source: 'sp500' },
  { symbol: 'WY', company_name: 'Weyerhaeuser Company', sector: 'Real Estate', data_source: 'sp500' },

  // Additional Materials - Mining, Metals, Commodities (50)
  { symbol: 'CLF', company_name: 'Cleveland-Cliffs Inc.', sector: 'Basic Materials', data_source: 'sp500' },
  { symbol: 'X', company_name: 'United States Steel Corp.', sector: 'Basic Materials', data_source: 'sp500' },
  { symbol: 'RS', company_name: 'Reliance Inc.', sector: 'Basic Materials', data_source: 'sp500' },
  { symbol: 'CMC', company_name: 'Commercial Metals Company', sector: 'Basic Materials', data_source: 'sp500' },
  { symbol: 'WOR', company_name: 'Worthington Enterprises Inc.', sector: 'Basic Materials', data_source: 'sp500' },
  { symbol: 'ATI', company_name: 'ATI Inc.', sector: 'Basic Materials', data_source: 'sp500' },
  { symbol: 'MP', company_name: 'MP Materials Corp.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'LAD', company_name: 'Lithium Americas Corp.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'SQM', company_name: 'Sociedad Quimica y Minera', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'HCC', company_name: 'Warrior Met Coal Inc.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'ARCH', company_name: 'Arch Resources Inc.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'BTU', company_name: 'Peabody Energy Corporation', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'AMR', company_name: 'Alpha Metallurgical Resources', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'CEIX', company_name: 'CONSOL Energy Inc.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'ARLP', company_name: 'Alliance Resource Partners LP', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'METC', company_name: 'Ramaco Resources Inc.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'HL', company_name: 'Hecla Mining Company', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'CDE', company_name: 'Coeur Mining Inc.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'AG', company_name: 'First Majestic Silver Corp.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'PAAS', company_name: 'Pan American Silver Corp.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'MAG', company_name: 'MAG Silver Corp.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'EXK', company_name: 'Endeavour Silver Corp.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'SAND', company_name: 'Sandstorm Gold Ltd.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'WPM', company_name: 'Wheaton Precious Metals', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'RGLD', company_name: 'Royal Gold Inc.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'OR', company_name: 'Osisko Gold Royalties Ltd.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'FNV', company_name: 'Franco-Nevada Corporation', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'GOLD', company_name: 'Barrick Gold Corporation', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'AEM', company_name: 'Agnico Eagle Mines Ltd.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'KGC', company_name: 'Kinross Gold Corporation', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'AU', company_name: 'AngloGold Ashanti Limited', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'IAG', company_name: 'Iamgold Corporation', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'NGD', company_name: 'New Gold Inc.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'BTG', company_name: 'B2Gold Corp.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'SSRM', company_name: 'SSR Mining Inc.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'AGI', company_name: 'Alamos Gold Inc.', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'EDV', company_name: 'Endeavour Mining Corporation', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'EGO', company_name: 'Eldorado Gold Corporation', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'GDXJ', company_name: 'VanEck Junior Gold Miners ETF', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'GDX', company_name: 'VanEck Gold Miners ETF', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'RING', company_name: 'iShares MSCI Global Gold Miners', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'COPX', company_name: 'Global X Copper Miners ETF', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'PICK', company_name: 'iShares MSCI Global Metals', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'SLV', company_name: 'iShares Silver Trust', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'GLD', company_name: 'SPDR Gold Trust', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'GLDM', company_name: 'SPDR Gold MiniShares Trust', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'IAU', company_name: 'iShares Gold Trust', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'SGOL', company_name: 'abrdn Physical Gold Shares ETF', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'OUNZ', company_name: 'VanEck Merk Gold Trust', sector: 'Basic Materials', data_source: 'nasdaq' },
  { symbol: 'BAR', company_name: 'GraniteShares Gold Trust', sector: 'Basic Materials', data_source: 'nasdaq' },
];

/**
 * FRIDAY UNIVERSE - 200 stocks
 * Theme: Cyclical & Small-cap Growth (volatility plays, meme stocks, growth opportunities)
 */
export const FRIDAY_UNIVERSE: StockUniverseEntry[] = [
  // High-volatility growth & meme stocks (60)
  { symbol: 'PLTR', company_name: 'Palantir Technologies Inc.', sector: 'Technology', data_source: 'high_volume' },
  { symbol: 'SOFI', company_name: 'SoFi Technologies Inc.', sector: 'Financial', data_source: 'high_volume' },
  { symbol: 'RIVN', company_name: 'Rivian Automotive Inc.', sector: 'Consumer Cyclical', data_source: 'high_volume' },
  { symbol: 'LCID', company_name: 'Lucid Group Inc.', sector: 'Consumer Cyclical', data_source: 'high_volume' },
  ...
  { symbol: 'RIOT', company_name: 'Riot Platforms Inc.', sector: 'Financial', data_source: 'high_volume' },
  { symbol: 'MSTR', company_name: 'MicroStrategy Inc.', sector: 'Technology', data_source: 'high_volume' },
  { symbol: 'HOOD', company_name: 'Robinhood Markets Inc.', sector: 'Financial', data_source: 'high_volume' },
  { symbol: 'UPST', company_name: 'Upstart Holdings Inc.', sector: 'Financial', data_source: 'high_volume' },
  { symbol: 'AFRM', company_name: 'Affirm Holdings Inc.', sector: 'Financial', data_source: 'high_volume' },
  { symbol: 'DASH', company_name: 'DoorDash Inc.', sector: 'Technology', data_source: 'high_volume' },
  { symbol: 'DKNG', company_name: 'DraftKings Inc.', sector: 'Consumer Cyclical', data_source: 'high_volume' },
  { symbol: 'CHWY', company_name: 'Chewy Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'W', company_name: 'Wayfair Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'PTON', company_name: 'Peloton Interactive Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'FSLR', company_name: 'First Solar Inc.', sector: 'Technology', data_source: 'sp500' },
  { symbol: 'ENPH', company_name: 'Enphase Energy Inc.', sector: 'Technology', data_source: 'sp500' },
  { symbol: 'SEDG', company_name: 'SolarEdge Technologies Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'RUN', company_name: 'Sunrun Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'PLUG', company_name: 'Plug Power Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'BE', company_name: 'Bloom Energy Corporation', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'FCEL', company_name: 'FuelCell Energy Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'BLNK', company_name: 'Blink Charging Co.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'CHPT', company_name: 'ChargePoint Holdings Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'EVGO', company_name: 'EVgo Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'QS', company_name: 'QuantumScape Corporation', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'NKLA', company_name: 'Nikola Corporation', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'FSR', company_name: 'Fisker Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'GOEV', company_name: 'Canoo Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'LEV', company_name: 'Lion Electric Company', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'LAZR', company_name: 'Luminar Technologies Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'VLDR', company_name: 'Velodyne Lidar Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'LIDR', company_name: 'AEye Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'OUST', company_name: 'Ouster Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'SPCE', company_name: 'Virgin Galactic Holdings Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'RDW', company_name: 'Redwire Corporation', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'ASTR', company_name: 'Astra Space Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'RKLB', company_name: 'Rocket Lab USA Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'ARVL', company_name: 'Arrival Group', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'JOBY', company_name: 'Joby Aviation Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'LILM', company_name: 'Lilium N.V.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'ACHR', company_name: 'Archer Aviation Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'EH', company_name: 'EHang Holdings Limited', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'BLDE', company_name: 'Blade Air Mobility Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'EXPC', company_name: 'Experience Investment Corp.', sector: 'Financial', data_source: 'nasdaq' },

  // Small-cap growth & speculative tech (60)
  { symbol: 'AI', company_name: 'C3.ai Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'PATH', company_name: 'UiPath Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'SNOW', company_name: 'Snowflake Inc.', sector: 'Technology', data_source: 'sp500' },
  { symbol: 'NET', company_name: 'Cloudflare Inc.', sector: 'Technology', data_source: 'sp500' },
  { symbol: 'DDOG', company_name: 'Datadog Inc.', sector: 'Technology', data_source: 'sp500' },
  { symbol: 'CRWD', company_name: 'CrowdStrike Holdings Inc.', sector: 'Technology', data_source: 'sp500' },
  { symbol: 'ZS', company_name: 'Zscaler Inc.', sector: 'Technology', data_source: 'sp500' },
  { symbol: 'S', company_name: 'SentinelOne Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'OKTA', company_name: 'Okta Inc.', sector: 'Technology', data_source: 'sp500' },
  { symbol: 'FSLY', company_name: 'Fastly Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'ESTC', company_name: 'Elastic N.V.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'MDB', company_name: 'MongoDB Inc.', sector: 'Technology', data_source: 'sp500' },
  { symbol: 'CFLT', company_name: 'Confluent Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'GTLB', company_name: 'GitLab Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'RELY', company_name: 'Remitly Global Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'BILL', company_name: 'Bill.com Holdings Inc.', sector: 'Technology', data_source: 'sp500' },
  { symbol: 'BRZE', company_name: 'Braze Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'TWLO', company_name: 'Twilio Inc.', sector: 'Technology', data_source: 'sp500' },
  { symbol: 'PINS', company_name: 'Pinterest Inc.', sector: 'Communication Services', data_source: 'sp500' },
  { symbol: 'RDDT', company_name: 'Reddit Inc.', sector: 'Communication Services', data_source: 'nasdaq' },
  { symbol: 'SPOT', company_name: 'Spotify Technology S.A.', sector: 'Communication Services', data_source: 'sp500' },
  { symbol: 'MTCH', company_name: 'Match Group Inc.', sector: 'Communication Services', data_source: 'sp500' },
  { symbol: 'BMBL', company_name: 'Bumble Inc.', sector: 'Communication Services', data_source: 'nasdaq' },
  { symbol: 'DUOL', company_name: 'Duolingo Inc.', sector: 'Communication Services', data_source: 'nasdaq' },
  { symbol: 'CPNG', company_name: 'Coupang Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'SE', company_name: 'Sea Limited', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'GRAB', company_name: 'Grab Holdings Limited', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'DIDI', company_name: 'DiDi Global Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'BABA', company_name: 'Alibaba Group Holding Limited', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'JD', company_name: 'JD.com Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'PDD', company_name: 'PDD Holdings Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'BIDU', company_name: 'Baidu Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'BILI', company_name: 'Bilibili Inc.', sector: 'Communication Services', data_source: 'nasdaq' },
  { symbol: 'IQ', company_name: 'iQIYI Inc.', sector: 'Communication Services', data_source: 'nasdaq' },
  { symbol: 'NTES', company_name: 'NetEase Inc.', sector: 'Communication Services', data_source: 'nasdaq' },
  { symbol: 'FUTU', company_name: 'Futu Holdings Limited', sector: 'Financial', data_source: 'nasdaq' },
  { symbol: 'TIGR', company_name: 'UP Fintech Holding Limited', sector: 'Financial', data_source: 'nasdaq' },
  { symbol: 'SOUN', company_name: 'SoundHound AI Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'BBAI', company_name: 'BigBear.ai Holdings Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'IONQ', company_name: 'IonQ Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'RGTI', company_name: 'Rigetti Computing Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'QUBT', company_name: 'Quantum Computing Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'ARQQ', company_name: 'Arqit Quantum Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'SMCI', company_name: 'Super Micro Computer Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'AVGO', company_name: 'Broadcom Inc.', sector: 'Technology', data_source: 'sp500' },
  { symbol: 'ARM', company_name: 'Arm Holdings plc', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'ASTS', company_name: 'AST SpaceMobile Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'LUNR', company_name: 'Intuitive Machines Inc.', sector: 'Industrials', data_source: 'nasdaq' },
  { symbol: 'GSAT', company_name: 'Globalstar Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'IRDM', company_name: 'Iridium Communications Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'VSAT', company_name: 'Viasat Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'SATS', company_name: 'EchoStar Corporation', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'VERB', company_name: 'Verb Technology Company', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'NNDM', company_name: 'Nano Dimension Ltd.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'DM', company_name: 'Desktop Metal Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'MTTR', company_name: 'Matterport Inc.', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'PRNT', company_name: 'The 3D Printing ETF', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'VUZI', company_name: 'Vuzix Corporation', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'KOPN', company_name: 'Kopin Corporation', sector: 'Technology', data_source: 'nasdaq' },
  { symbol: 'WIMI', company_name: 'WiMi Hologram Cloud Inc.', sector: 'Technology', data_source: 'nasdaq' },

  // Cyclical & recovery plays (40)
  { symbol: 'CCL', company_name: 'Carnival Corporation', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'RCL', company_name: 'Royal Caribbean Cruises', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'NCLH', company_name: 'Norwegian Cruise Line Holdings', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'LVS', company_name: 'Las Vegas Sands Corp.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  ...
  { symbol: 'MGM', company_name: 'MGM Resorts International', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'PENN', company_name: 'PENN Entertainment Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'CZR', company_name: 'Caesars Entertainment Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'BYD', company_name: 'Boyd Gaming Corporation', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'CHDN', company_name: 'Churchill Downs Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'BALY', company_name: 'Bally\'s Corporation', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'RSI', company_name: 'Rush Street Interactive Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'FLUT', company_name: 'Flutter Entertainment plc', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'BKNG', company_name: 'Booking Holdings Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'EXPE', company_name: 'Expedia Group Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'TRIP', company_name: 'TripAdvisor Inc.', sector: 'Communication Services', data_source: 'nasdaq' },
  { symbol: 'TCOM', company_name: 'Trip.com Group Limited', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'MAR', company_name: 'Marriott International Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'HLT', company_name: 'Hilton Worldwide Holdings', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'H', company_name: 'Hyatt Hotels Corporation', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'IHG', company_name: 'InterContinental Hotels Group', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'WH', company_name: 'Wyndham Hotels & Resorts Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'RHP', company_name: 'Ryman Hospitality Properties Inc.', sector: 'Real Estate', data_source: 'sp500' },
  { symbol: 'APLE', company_name: 'Apple Hospitality REIT Inc.', sector: 'Real Estate', data_source: 'nasdaq' },
  { symbol: 'HST', company_name: 'Host Hotels & Resorts Inc.', sector: 'Real Estate', data_source: 'sp500' },
  { symbol: 'SOHO', company_name: 'Sotherly Hotels Inc.', sector: 'Real Estate', data_source: 'nasdaq' },
  { symbol: 'PK', company_name: 'Park Hotels & Resorts Inc.', sector: 'Real Estate', data_source: 'sp500' },
  { symbol: 'BBBY', company_name: 'Bed Bath & Beyond Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'DDS', company_name: 'Dillard\'s Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'M', company_name: 'Macy\'s Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'KSS', company_name: 'Kohl\'s Corporation', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'JWN', company_name: 'Nordstrom Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'URBN', company_name: 'Urban Outfitters Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'ANF', company_name: 'Abercrombie & Fitch Co.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'AEO', company_name: 'American Eagle Outfitters Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'GPS', company_name: 'Gap Inc.', sector: 'Consumer Cyclical', data_source: 'sp500' },
  { symbol: 'EXPR', company_name: 'Express Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'FIVE', company_name: 'Five Below Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'OLLI', company_name: 'Ollie\'s Bargain Outlet Holdings', sector: 'Consumer Cyclical', data_source: 'nasdaq' },
  { symbol: 'BIG', company_name: 'Big Lots Inc.', sector: 'Consumer Cyclical', data_source: 'nasdaq' },

  // High-beta energy & mining cyclicals (40)
  { symbol: 'DVN', company_name: 'Devon Energy Corporation', sector: 'Energy', data_source: 'sp500' },
  ...
  { symbol: 'FANG', company_name: 'Diamondback Energy Inc.', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'EOG', company_name: 'EOG Resources Inc.', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'PXD', company_name: 'Pioneer Natural Resources Co.', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'COP', company_name: 'ConocoPhillips', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'HES', company_name: 'Hess Corporation', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'CVE', company_name: 'Cenovus Energy Inc.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'SU', company_name: 'Suncor Energy Inc.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'CNQ', company_name: 'Canadian Natural Resources', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'IMO', company_name: 'Imperial Oil Limited', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'OVV', company_name: 'Ovintiv Inc.', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'CTRA', company_name: 'Coterra Energy Inc.', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'AR', company_name: 'Antero Resources Corporation', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'MUR', company_name: 'Murphy Oil Corporation', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'SM', company_name: 'SM Energy Company', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'MTDR', company_name: 'Matador Resources Company', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'PR', company_name: 'Permian Resources Corporation', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'CLR', company_name: 'Continental Resources Inc.', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'RRC', company_name: 'Range Resources Corporation', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'EQT', company_name: 'EQT Corporation', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'GPOR', company_name: 'Gulfport Energy Corporation', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'CHRD', company_name: 'Chord Energy Corporation', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'MGY', company_name: 'Magnolia Oil & Gas Corporation', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'NOG', company_name: 'Northern Oil and Gas Inc.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'CRK', company_name: 'Comstock Resources Inc.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'CIVI', company_name: 'Civitas Resources Inc.', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'VTLE', company_name: 'Vital Energy Inc.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'SD', company_name: 'SandRidge Energy Inc.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'CRR', company_name: 'CARBO Ceramics Inc.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'HP', company_name: 'Helmerich & Payne Inc.', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'NBR', company_name: 'Nabors Industries Ltd.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'VAL', company_name: 'Valaris Limited', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'NE', company_name: 'Noble Corporation plc', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'RIG', company_name: 'Transocean Ltd.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'DO', company_name: 'Diamond Offshore Drilling Inc.', sector: 'Energy', data_source: 'nasdaq' },
  { symbol: 'PTEN', company_name: 'Patterson-UTI Energy Inc.', sector: 'Energy', data_source: 'sp500' },
  { symbol: 'SLB', company_name: 'Schlumberger N.V.', sector: 'Energy', data_source: 'sp500' },
];

/**
 * Get the stock universe for the current day of the week
 * @returns Array of stocks to scan today
 */
export function getTodaysUniverse(): StockUniverseEntry[] {
...
/**
 * Get universe for a specific day (for testing/preview)
 * @param day Day of week (1=Mon, 2=Tue, 3=Wed, 4=Thu, 5=Fri)
 */
export function getUniverseForDay(day: number): StockUniverseEntry[] {
  switch (day) {
    case 1: return MONDAY_UNIVERSE;
    case 2: return TUESDAY_UNIVERSE;
    case 3: return WEDNESDAY_UNIVERSE;
    case 4: return THURSDAY_UNIVERSE;
    case 5: return FRIDAY_UNIVERSE;
    default: return [];
  }
}

/**
 * Get all unique stocks across the entire week
 */
export function getAllWeeklyStocks(): StockUniverseEntry[] {
  const allStocks = [
    ...MONDAY_UNIVERSE,
    ...TUESDAY_UNIVERSE,
    ...WEDNESDAY_UNIVERSE,
  ...
  const uniqueMap = new Map<string, StockUniverseEntry>();
  allStocks.forEach(stock => uniqueMap.set(stock.symbol, stock));
...
export function getRotationStats() {
  return {
    monday: MONDAY_UNIVERSE.length,
    tuesday: TUESDAY_UNIVERSE.length,
    wednesday: WEDNESDAY_UNIVERSE.length,
    thursday: THURSDAY_UNIVERSE.length,
    friday: FRIDAY_UNIVERSE.length,
    total: getAllWeeklyStocks().length,
  };
}
